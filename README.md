...
「教材パック」画面の **内蔵教材ライブラリ** から、1,700件超の教材(化学・材料/貿易・物流/営業・商談/価格交渉・納期・品質/電話対応/ウェブ会議/工場査察/ホテル/日常会話/口語表現/新聞・時事/半導体/化学合成/有機化学/中国・台湾の歴史・地理・社会/長文など24パック)をワンクリックで追加できます。「すべて追加」でまとめて追加も可能です。追加済みの教材は重複としてスキップされるので、何度押しても安全です。ライブラリが更新された後も、再度「すべて追加」を押せば新規分だけが取り込まれます。
